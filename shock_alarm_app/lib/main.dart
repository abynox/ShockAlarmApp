  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Observer(builder: (context) {
        ...
        */
        return ScreenSelector(alarms: list);
      }));
  }
}
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            FloatingActionButton(onPressed: _testButton, child: const Text('Test')),
            Card(child: Padding(padding: const EdgeInsets.all(16), child: 
              Column(children: [
                FloatingActionButton(child: Text(_time!.format(context)), onPressed: _timePicker),
                Row(children: [
                  OutlinedButton(onPressed: null, child: Text("M")),
                  OutlinedButton(onPressed: null, child: Text("T")),
                  OutlinedButton(onPressed: null, child: Text("W")),
                  OutlinedButton(onPressed: null, child: Text("T")),
                  OutlinedButton(onPressed: null, child: Text("F")),
                  OutlinedButton(onPressed: null, child: Text("S")),
                  OutlinedButton(onPressed: null, child: Text("S")),
                ]),
